...
class RemoveUserForTeamRequestBody:
    r"""The user to remove from the team."""
    data: Optional[shared_teamremoveuserrequest.TeamRemoveUserRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class RemoveUserForTeamRequest:
    request_body: RemoveUserForTeamRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The user to remove from the team."""
...
class RemoveUserForTeam204ApplicationJSON:
    r"""Returns an empty data record"""
