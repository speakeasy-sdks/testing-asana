...
class GetTeamMembershipsRequest:
    ...
    r"""A string identifying a user. This can either be the string \\"me\\", an email, or the gid of a user. This parameter must be used with the workspace parameter."""
    workspace: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'workspace', 'style': 'form', 'explode': True }})
    r"""Globally unique identifier for the workspace. This parameter must be used with the user parameter."""
...
class GetTeamMemberships200ApplicationJSON:
    r"""Successfully retrieved the requested team memberships."""
