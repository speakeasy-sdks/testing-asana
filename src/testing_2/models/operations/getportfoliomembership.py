...
class GetPortfolioMembership200ApplicationJSON:
    r"""Successfully retrieved the requested portfolio membership."""
    data: Optional[shared_portfoliomembershipresponse.PortfolioMembershipResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
