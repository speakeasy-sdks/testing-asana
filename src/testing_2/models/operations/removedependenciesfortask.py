...
class RemoveDependenciesForTaskRequestBody:
    r"""The list of tasks to unlink as dependencies."""
...
class RemoveDependenciesForTaskRequest:
    request_body: RemoveDependenciesForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The list of tasks to unlink as dependencies."""
...
class RemoveDependenciesForTask200ApplicationJSON:
    r"""Successfully unlinked the dependencies from the specified task."""
