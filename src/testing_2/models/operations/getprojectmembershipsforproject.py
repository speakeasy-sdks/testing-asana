...
class GetProjectMembershipsForProject200ApplicationJSON:
    r"""Successfully retrieved the requested project's memberships."""
    data: Optional[list[shared_projectmembershipcompact.ProjectMembershipCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
