...
class RemoveUserForWorkspaceRequestBody:
    r"""The user to remove from the workspace."""
    data: Optional[shared_workspaceremoveuserrequest.WorkspaceRemoveUserRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class RemoveUserForWorkspaceRequest:
    request_body: RemoveUserForWorkspaceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The user to remove from the workspace."""
...
class RemoveUserForWorkspace204ApplicationJSON:
    r"""The user was removed successfully to the workspace or organization."""
