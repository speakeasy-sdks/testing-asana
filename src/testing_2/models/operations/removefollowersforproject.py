...
class RemoveFollowersForProjectRequestBody:
    r"""Information about the followers being removed."""
    data: Optional[shared_removefollowersrequest.RemoveFollowersRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class RemoveFollowersForProjectRequest:
    ...
    request_body: RemoveFollowersForProjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Information about the followers being removed."""
...
class RemoveFollowersForProject200ApplicationJSON:
    r"""Successfully removed followers from the project."""
