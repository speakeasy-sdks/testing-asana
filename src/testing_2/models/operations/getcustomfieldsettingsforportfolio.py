...
class GetCustomFieldSettingsForPortfolio200ApplicationJSON:
    r"""Successfully retrieved custom field settings objects for a portfolio."""
...
class GetCustomFieldSettingsForPortfolioResponse:
    ...
    get_custom_field_settings_for_portfolio_200_application_json_object: Optional[GetCustomFieldSettingsForPortfolio200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successfully retrieved custom field settings objects for a portfolio."""
