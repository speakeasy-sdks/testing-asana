...
class UpdateTeamRequest:
    request_body: UpdateTeamRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The team to update."""
...
class UpdateTeam200ApplicationJSON:
    r"""Successfully updated the team."""
...
class UpdateTeamResponse:
    ...
    update_team_200_application_json_object: Optional[UpdateTeam200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successfully updated the team."""
