...
class DuplicateProjectRequestBody:
    r"""Describes the duplicate's name and the elements that will be duplicated."""
    data: Optional[shared_projectduplicaterequest.ProjectDuplicateRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class DuplicateProjectRequest:
    ...
    """
    request_body: Optional[DuplicateProjectRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Describes the duplicate's name and the elements that will be duplicated."""
