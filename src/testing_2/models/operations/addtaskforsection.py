...
class AddTaskForSectionRequestBody:
    r"""The task and optionally the insert location."""
    data: Optional[shared_sectiontaskinsertrequest.SectionTaskInsertRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class AddTaskForSectionRequest:
    request_body: AddTaskForSectionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The task and optionally the insert location."""
