...
class GetProjectsRequest:
    ...
    r"""The workspace or organization to filter projects on."""
...
class GetProjectsResponse:
    ...
    get_projects_200_application_json_object: Optional[GetProjects200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successfully retrieved projects."""
