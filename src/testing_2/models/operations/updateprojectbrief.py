...
class UpdateProjectBriefRequestBodyInput:
    r"""The updated fields for the project brief."""
...
class UpdateProjectBriefRequest:
    ...
    request_body: UpdateProjectBriefRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The updated fields for the project brief."""
...
class UpdateProjectBrief200ApplicationJSON:
    r"""Successfully updated the project brief."""
...
class UpdateProjectBriefResponse:
    ...
    update_project_brief_200_application_json_object: Optional[UpdateProjectBrief200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successfully updated the project brief."""
