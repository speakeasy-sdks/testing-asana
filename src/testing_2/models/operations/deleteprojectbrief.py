...
class DeleteProjectBrief200ApplicationJSON:
    r"""Successfully deleted the specified project brief."""
...
class DeleteProjectBriefResponse:
    ...
    delete_project_brief_200_application_json_object: Optional[DeleteProjectBrief200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successfully deleted the specified project brief."""
