...
class RemoveFollowersRequestBody:
    r"""The followers to be removed as collaborators"""
...
class RemoveFollowersRequest:
    ...
    request_body: RemoveFollowersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The followers to be removed as collaborators"""
...
class RemoveFollowers200ApplicationJSON:
    r"""Successfully removed users as collaborators."""
...
class RemoveFollowersResponse:
    ...
    remove_followers_200_application_json_object: Optional[RemoveFollowers200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successfully removed users as collaborators."""
