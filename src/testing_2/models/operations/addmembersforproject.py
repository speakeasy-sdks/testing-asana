...
class AddMembersForProjectRequest:
    ...
    request_body: AddMembersForProjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Information about the members being added."""
...
class AddMembersForProject200ApplicationJSON:
    r"""Successfully added members to the project."""
