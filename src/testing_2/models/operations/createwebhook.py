...
class CreateWebhookRequestBody:
    r"""The webhook workspace and target."""
    data: Optional[shared_webhookrequest.WebhookRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class CreateWebhook201ApplicationJSON:
    r"""Successfully created the requested webhook."""
